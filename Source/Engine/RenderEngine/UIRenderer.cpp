...
bool UIRenderer::Init()
{
    ...
    // Upload Fonts
    {
        io.FontDefault = io.Fonts->AddFontFromFileTTF("D:/Programming/HorizonTest/Assets/Fonts/Consolas/consola.ttf", 16.0f);
    ...
    includeDirs.push_back(TEXT("D:/Programming/Projects/Horizon/Shaders"));
    LoadShaderSourceFromFile("D:/Programming/Projects/Horizon/Shaders/ImGui.hsf", source);
    CompileShader(
        shaderCompiler,
        source,
        TEXT("ImGuiVS"),
    ...
    for (int i = 0; i < drawData->CmdListsCount; i++)
    {
        ...
        for (int drawCallIndex = 0; drawCallIndex < cmdList->CmdBuffer.Size; drawCallIndex++)
        {
            ...
            RenderBackendScissor scissor = {
                .left = (int32)(clipMin.x),
                .top = (int32)(clipMin.y),
                .width = (uint32)(clipMax.x - clipMin.x),
                .height = (uint32)(clipMax.y - clipMin.y),
            };
