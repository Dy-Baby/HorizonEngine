...
#define HE_ARENA_ALLOC(arena, size)                                          (ArenaRealloc(arena, nullptr, 0,       size,    HE_DEFAULT_ALIGNMENT, __FILE__, __LINE__))
#define HE_ARENA_FREE(arena, ptr, size)                                      (ArenaRealloc(arena, ptr,     size,    0,       HE_DEFAULT_ALIGNMENT, __FILE__, __LINE__))
#define HE_ARENA_REALLOC(arena, ptr, oldSize, newSize)                       (ArenaRealloc(arena, ptr,     oldSize, newSize, HE_DEFAULT_ALIGNMENT, __FILE__, __LINE__))
#define HE_ARENA_ALIGNED_ALLOC(arena, size, alignment)                       (ArenaRealloc(arena, nullptr, 0,       size,    alignment,            __FILE__, __LINE__))
#define HE_ARENA_ALIGNED_FREE(arena, ptr, size, alignment)                   (ArenaRealloc(arena, ptr,     size,    0,       alignment,            __FILE__, __LINE__))
#define HE_ARENA_ALIGNED_REALLOC(arena, ptr, oldSize, newSize, alignment)    (ArenaRealloc(arena, ptr,     oldSize, newSize, alignment,            __FILE__, __LINE__))
...
extern void* ArenaRealloc(MemoryArena* arena, void* ptr, uint64 oldSize, uint64 newSize, uint64 alignment, const char* file, uint32 line);
